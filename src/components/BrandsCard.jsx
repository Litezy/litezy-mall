...
const BrandsCard = () => {
    ...
    return (
        <div className='md:w-[95%] mx-auto md:h-screen md:mb-20'>
            <div className="md:flex items-center justify-between  md:gap-6 md:h-screen w-full mt-2">
                <div className="bg-[#fff9ef] md:h-fit pb-5 h-fit md:w-[50%] mb-5 md:mb-0  ">
                    <div className="flex items-center justify-between px-5 md:mt-10 md:pt-0  pt-5">
                ...
                <div className="bg-[#fff9ef] md:h-fit pb-5 h-fit md:w-[50%]">
                    <div className="flex items-center justify-between px-5 md:mt-10 md:pt-0  pt-5">
